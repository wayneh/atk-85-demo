...
<br/>
                <?php $_from = $this->_tpl_vars['errors']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (atkcount($_from)):
...
: <?php echo $this->_tpl_vars['error']['message']; ?>
 ...
 <?php echo $this->_tpl_vars['error']['tablink']; ?>
    ...
    <?php endif; ?>
    <?php $_from = $this->_tpl_vars['fieldspart']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (atkcount($_from)):
