<?php /* Smarty version 2.6.30, created on 2020-07-10 05:03:36
         compiled from ./atk/themes/steelblue/templates/tabs.tpl */ ?>
<script language="JavaScript" type="text/javascript">
    var tabs = new Array();
    <?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
$this->_sections['i']['loop'] = is_array($_loop=$this->_tpl_vars['tabs']) ? atkcount($_loop) : max(0, (int)$_loop); unset($_loop);
